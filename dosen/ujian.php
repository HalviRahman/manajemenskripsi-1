                            ...
                            <div class="col-lg-12">
                                <div class="card mb-4">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Data Ujian Mahasiswa</h6>
                                    </div>
                                    <div class="table-responsive p-3">
                                        <table class="table align-items-center table-flush" id="dataTableHover">
                                            ...
                                            <tbody>
                                                ...
                                                $stmt = $conn->prepare("SELECT * FROM pengajuanjudul WHERE verifikasifile=1");
                                                $stmt->execute();
                                                ...
                                                $stmt = $conn->prepare("SELECT * FROM ujianproposal WHERE verifikasifile=1");
                                                $stmt->execute();
                                                $result = $stmt->get_result();
                                                while ($dhasil = $result->fetch_assoc()) {
                                                    $nim = $dhasil['nim'];
