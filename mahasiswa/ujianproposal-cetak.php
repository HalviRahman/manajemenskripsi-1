...
//get data penelitian
$no = 1;
$stmt = $conn->prepare("SELECT * FROM ujianproposal WHERE token='$token'");
$stmt->execute();
    ...
    <tbody>
        <tr>
            <td colspan="6" align="center">
                ...
                <b>SEMINAR PROPOSAL SKRIPSI</b></br />
...
<table table style="width:80%; margin-left:auto;margin-right:auto;" cellspacing="0" border="0">
    <tr>
        <td colspan="2">
            Berdasarkan hasil keputusan dewan penguji seminar proposal skripsi pada Bulan <?= bulan(date('m', strtotime($jadwalujian))); ?> <?= date('Y', strtotime($jadwalujian)); ?>, dengan ini menerangkan bahwa:
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        <td colspan="2">
            telah melaksanakan seminar proposal skripsi dan dinyatakan <b>LULUS</b>.
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
