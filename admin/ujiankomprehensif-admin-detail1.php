                            ...
                            <div class="card mb-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="my-form">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <button type="submit" class="btn btn-success btn-lg btn-block" id="btn-submit" formaction="ujiankomprehensif-admin-setujui1.php" onclick="return confirm('Menyetujui pengajuan ini ?')">SETUJUI</button>
                                            </div>
                                            <div class="col">
