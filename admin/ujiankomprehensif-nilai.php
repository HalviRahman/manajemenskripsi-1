            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Laporan Nilai Ujian Komprehensif</h1>
                        <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Laporan Nilai Ujian Komprehensif</h6>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?= number_format(($nilai1 + $nilai2) / 2, 2) + 0; ?></td>
                                                    <td class="text-center"><?= nilai(($nilai1 + $nilai2) / 2); ?></td>
                                                </tr>
                                            <?php
                                                $no++;
                                            }
