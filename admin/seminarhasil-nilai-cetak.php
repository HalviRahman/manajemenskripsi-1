...
<table table style="width:90%; margin-left:auto;margin-right:auto;" cellspacing="0" border="1">
    <thead>
        <tr>
            ...
            <th class="text-center">Nilai Penguji Anggota 2</th>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td align="center" width="12%"><?= $nilaipembimbing; ?></td>
                <td align="center" width="12%"><?= number_format(($nilai1 + $nilai2 + $nilaipembimbing) / 3, 2) + 0; ?></td>
                <td width="5%"><?= nilai(($nilai1 + $nilai2 + $nilaipembimbing) / 3); ?></td>
            </tr>
        <?php
            $no++;
        }
