...
if ($jsempro == 0 and $jkompre == 0 and $jsemhas == 0 and $jskripsi == 0) {
        ...
        <br/>
        Anda dijadwalkan untuk Ujian Seminar Proposal Mahasiswa bimbingan anda atas nama " . $namamhs . " NIM " . $nimmhs . " pada :
        <br/>
        ...
        Assalamualaikum Wr. Wb.
        <br/>
        Anda dijadwalkan untuk Ujian Seminar Proposal Mahasiswa atas nama " . $namamhs . " NIM " . $nimmhs . " <b>sebagai KETUA PENGUJI</b> pada :
        <br/>
        Hari : " . hari(date('N', strtotime($jadwalujian))) . "
        <br/>
        Tanggal : " . tgljam_indo($jadwalujian) . "
        ...
        Assalamualaikum Wr. Wb.
        <br/>
        Anda dijadwalkan untuk Ujian Seminar Proposal Mahasiswa pada :
        <br/>
        Hari : " . hari(date('N', strtotime($jadwalujian))) . "
        <br/>
        Tanggal : " . tgljam_indo($jadwalujian) . "
