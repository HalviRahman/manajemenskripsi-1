...
if ($jsempro == 0 and $jkompre == 0 and $jsemhas == 0 and $jskripsi == 0) {
        ...
        $subject = "Notifikasi Pelaksanaan Ujian Seminar Hasil";
        $pesan = "Yth. " . $namapembimbing . "
        <br/>
        Assalamualaikum Wr. Wb.
        <br/>
        Anda dijadwalkan untuk <b>Ujian Seminar Hasil </b> Mahasiswa atas nama " . $namamhs . " NIM " . $nimmhs . " sebagai <b>DOSEN PEMBIMBING</b> pada :
        <br/>
        ...
        Assalamualaikum Wr. Wb.
        <br/>
        Anda dijadwalkan untuk <b>Ujian Seminar Hasil</b> Mahasiswa atas nama " . $namamhs . " NIM " . $nimmhs . " <b>sebagai KETUA PENGUJI</b> pada :
        <br/>
        Hari : " . hari(date('N', strtotime($jadwalujian))) . "
        <br/>
        Tanggal : " . tgljam_indo($jadwalujian) . "
        ...
        Assalamualaikum Wr. Wb.
        <br/>
        Anda dijadwalkan untuk <b>Ujian Seminar Hasil</b> Mahasiswa atas nama " . $namamhs . " NIM " . $nimmhs . " <b>sebagai ANGGOTA PENGUJI</b> pada :
        <br/>
        Hari : " . hari(date('N', strtotime($jadwalujian))) . "
        <br/>
        Tanggal : " . tgljam_indo($jadwalujian) . "
        ...
        Assalamualaikum Wr. Wb.
        <br/>
        Anda dijadwalkan untuk <b>Ujian Seminar Hasil</b> pada :
        <br/>
        Hari : " . hari(date('N', strtotime($jadwalujian))) . "
        <br/>
        Tanggal : " . tgljam_indo($jadwalujian) . "
        ...
        header("location:seminarhasil-admin-detail2.php?token=$token&pesan=jadwalerror");
}
