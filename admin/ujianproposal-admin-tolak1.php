...
$nama = $_SESSION['nama'];
$nim = $_SESSION['nim'];
$namamhs = $_SESSION['namamhs'];
$nimmhs = $_SESSION['nimmhs'];
$token = $_POST['token'];
...
$subject = "Notifikasi Penolakan Pengajuan Ujian Seminar Proposal";
$pesan = "Yth. " . $namamhs . "
        <br/>
        Assalamualaikum Wr. Wb.
        <br/>
        Mohon maaf pengajuan Ujian Seminar Proposal anda <b>di tolak</b> oleh Program Studi dengan alasan <b>" . $keterangan . "</b>.
        <br/>
