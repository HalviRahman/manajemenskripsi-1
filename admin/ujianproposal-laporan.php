            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Laporan Ujian Seminar Proposal</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Laporan Ujian Seminar Proposal</li>
                        </ol>
                    </div>
                    <div class="row">
                        <form action="ujianproposal-laporan-cetak.php" method="POST">
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Laporan Ujian Seminar Proposal</h6>
                                </div>
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush" id="dataTable">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $stmt = $conn->prepare("SELECT * FROM ujianproposal WHERE status=4");
                                            $stmt->execute();
