...
$subject = "Notifikasi Penolakan Pengajuan Ujian Komprehensif";
$pesan = "Yth. " . $namamhs . "
        <br/>
        Assalamualaikum Wr. Wb.
        <br/>
        Mohon maaf pengajuan Ujian Komprehensif anda <b>di tolak</b> oleh Program Studi dengan alasan <b>" . $keterangan . "</b>.
        <br/>
